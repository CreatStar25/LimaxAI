#!/usr/bin/env python3
"""Audit OpenAI third-phase blog: parity, SEO, localized CTAs."""
...
SLUG = "openai-third-phase-ai-accessible-safe.md"
LOCALES = [
...
ZH_CN_H2 = ["三个发展阶段", "GPT 教程", "小结"]
EN_H2 = ["Three phases", "GPT tutorial", "Summary"]
EN_BODY_MARKERS = [
    "Keywords: chatgpt, GPT-5.6, gpt tutorial.",
    "Published: June 9, 2026",
    "It has been three and a half years since **ChatGPT**",
]
...
def main() -> int:
    ...
    for lang in LOCALES:
        ...
        if meta.get("pubDate") != "2026-06-09":
        ...
        if lang != "en":
            ...
            if en_h2 >= 3 or en_body >= 2:
                issues.append(f"EN fallback h2={en_h2} body={en_body}")

        if "openai-260609-1.png" not in body:
