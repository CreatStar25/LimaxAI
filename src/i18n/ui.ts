...
export interface UiCopy {
  ...
  footer: {
    brand: { title: string; intro: string; emailLabel: string };
...
const en: UiCopy = {
  ...
  footer: {
    ...
    links: {
      ...
      openclaw: 'Openclaw',
      gemini30: 'Gemini 3.0',
      watermarkErase: 'Watermark Erase',
      prompts: 'Prompts',
    },
...
const zhTW: UiCopy = withEnFallback({
  ...
  footer: {
    brand: { title: 'LimaxAI', intro: 'LimaxAI，專業 AI 生成平台。使用前沿模型創作精彩視頻與圖片。', emailLabel: '郵箱：' },
